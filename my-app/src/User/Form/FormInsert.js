...
function FormInsert({open, handleClose}) {
  ...
  return (
    <Dialog fullWidth={fullWidth} maxWidth={maxWidth} open={open} sx={{'& .MuiPaper-root': {border: '15px solid #FFFFFF',borderRadius: '8px',},}}>
<Container>
        <Stack direction="column" spacing={4} sx={{justifyContent: "center",alignItems: "flex-start",}}>
        
        <FormControl fullWidth>
          <TextField label="Número do Pedido" id="id_entrega" margin = "normal" value={text1} onChange={handleTextChange1}/>
          <TextField label="Nome do Cliente" id="id_entrega" margin = "normal" value={text2} onChange={handleTextChange2}/>
        </FormControl>
        ...
        <FormControl fullWidth>
        <TextField label="Observações (Opcional)" id="id_entrega" margin = "normal" value={text3} onChange={handleTextChange3}/>
        </FormControl>

        <Stack direction="row" spacing={110} sx={{justifyContent: "center",alignItems: "center",}}>
